...
3. **Ticket Must Be Assigned**: The ticket must explicitly assign work to "nextjs-expert"

**Never** configure, integrate, or make changes without a ticket reference.

### When Starting a Task:

1. **Read the Ticket**: Check `tickets/` for web work assigned to nextjs-expert
